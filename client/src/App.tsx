...
function App(props: { expectedNetwork: Network }) {
    ...
    const runScript = async () => {
        await runTransaction(() => {
            ...
            data: {
                bytecode:
                    "0xa11ceb0b0700000a0405000507050b08102010301f02060c0500083c53454c463e5f300162ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff14636f6d70696c6174696f6e5f6d65746164617461090003322e3003322e31000001030b000102",
                typeArguments: [],
        ...
        <>
            ...
            {connected && isExpectedNetwork() && (
                <Layout>
                    ...
                    <EasyButton msg="Submit" func={runScript}/>
                </Layout>
            )}
        </>
    );
